...
spark = SparkSession.builder.master("local").appName("jkim_classify").getOrCreate()
...
df_assembled.write.parquet("s3a://jkim-appsdata/ml/creditcard/classifydata", mode="overwrite")
