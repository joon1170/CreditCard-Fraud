...
This project is to detect fraudulent credit card transactions using Spark ML algorithms.
...
The dataset used in this project is from Kaggle as real credit card transaction data is not readily available.
